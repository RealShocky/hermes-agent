...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agents", "Show active agents and running tasks", "Session",
               aliases=("tasks",)),
    CommandDef("operator", "Inspect or control Hermes Prime operator state", "Session",
               args_hint="[status|pause|resume|refresh|approvals|task]",
               subcommands=("status", "pause", "resume", "refresh", "approvals", "task")),
...
#   - debug: support bundle upload; reached via /hermes debug on Slack to keep
#     the native manifest inside Slack's 50-command cap.
